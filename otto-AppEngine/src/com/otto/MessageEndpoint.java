 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "otto.com", ownerName = "otto.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyCnD1fdbk9WBQHOpk5Me9Ri2nBUenuNe_g";
