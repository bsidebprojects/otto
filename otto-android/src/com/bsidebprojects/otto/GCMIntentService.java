...
public class GCMIntentService extends GCMBaseIntentService {
  ...
  public void onMessage(Context context, Intent intent) {
    ...
    if(message.startsWith("move@")) {
    	...
    	Intent broadcastIntent = new Intent("com.otto.android.action.broadcast");
    	broadcastIntent.putExtra("service", fields[1]);
    	broadcastIntent.putExtra("latitude", Double.parseDouble(fields[2]));
    	broadcastIntent.putExtra("longitude", Double.parseDouble(fields[3]));
    	...
    	Intent broadcastIntent = new Intent("com.otto.android.action.broadcast");
    	broadcastIntent.putExtra("service", fields[1]);
    	broadcastIntent.putExtra("message", fields[2]);
